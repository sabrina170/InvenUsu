...
class UsuarioDao extends Conexion
{
    ...
    {
        $query = "SELECT codigo,codigonum,nombre,email,usuario,privilegio,fecha_registro FROM usuarios WHERE usuario = :usuario AND password = :password";
        ...
        $usuario->setCodigonum($filas["codigonum"]);
    ...
    {
        $query = "INSERT INTO usuarios (codigonum,nombre,email,usuario,password,privilegio) VALUES (:codigonum,:nombre,:email,:usuario,:password,:privilegio)";

        self::getConexion();

        $resultado = self::$cnx->prepare($query);

        $resultado->bindValue(":codigonum", $usuario->getCodigonum());
